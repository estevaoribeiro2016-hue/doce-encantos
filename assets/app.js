...
$('#receipt').onchange=()=>{ $('#receiptStatus').textContent='Comprovante recebido. Encantina AI: pagamento confirmado (simulado).'; };
$('#sendOrder').onclick=()=>{
...
$('#openAi').onclick=()=>$('#aiPop').classList.add('open'); $('#closeAi').onclick=()=>$('#aiPop').classList.remove('open');
